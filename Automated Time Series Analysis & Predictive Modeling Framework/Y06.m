...
%	Data file Y06.M
%
% Solar irradiance on a spot in Finland, during a 4-day summer time period. 
%
	...
	y = 100*y ; 
	Ts = 1 ; 
	unit = 'Time [T_s = 33 minutes]' ; 
	ntime  = 0:(length(y)-1); 
	label = 'Solar irradiance on a spot in Finland, during a 4-day summer time period.' ; 
	yunit = 'Irradiance [W/m^2]' ;
