...
%	Data file Y05.M
%
% Monthly amount of Belgian reinvestments between 1980 and 1990. 
%
	...
	y=[y 8.10 7.46 7.51 8.00 6.77 7.52 7.28 6.52 ...
	   ...
	   6.72 7.77 7.74 6.75 7.32 7.86] ;

	Ts = 1 ; 
	unit = 'Time [months]' ; 
	ntime  = 0:(length(y)-1) ;
	label = 'Monthly amount of Belgian reinvestments (1980-1990).' ; 
	yunit = 'Monthly amount [BFr billions]' ;
